...
<div>
    <button id = "b_tag1" onclick="checked('tag1')" style="{{button_style}}" onmouseover="func_hover('b_tag1')" onmouseout= "func_out('b_tag1')"> <input type="checkbox" id="tag1" disabled="disabled" checked=checked status="display:none">Tag 1</button>
